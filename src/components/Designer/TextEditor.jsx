...
const TextEditor = ({ onAddText, onUpdateText, currentTextId }) => {
  ...
  const handleFormChange = (changedValues, allValues) => {
    setTextProperties(allValues);
    onUpdateText = (allValues);
    if (currentTextId && onUpdateText) {
      console.log('Calling onUpdateText with:', { currentTextId, allValues });


      onUpdateText(currentTextId, changedValues);
    }
    console.log('文本发生变化:', changedValues);
  }
